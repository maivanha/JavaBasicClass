				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="${pageContext.request.contextPath }/"><img style="width: 160px" src="${pageContext.request.contextPath }/resources/images/home/logo.png" alt="" /></a>
						</div>
						...
						<div class="mainmenu pull-left">
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<c:forEach items="${danhmucs}" var="dm">
                                 <li><a style="font-family:monospace;font-style: oblique;" href="${pageContext.request.contextPath }/getAllSPintCategory/${dm.madanhmuc}">${dm.getTendanhmuc()}</a></li>
                                 </c:forEach>
