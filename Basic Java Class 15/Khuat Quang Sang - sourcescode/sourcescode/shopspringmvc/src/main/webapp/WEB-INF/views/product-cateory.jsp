								...
								<div class="product-image-wrapper">
									<div class="single-products">
										<div class="productinfo text-center">
											<img src="${pageContext.request.contextPath }/resources/images/sanpham/${sp.hinhanh}" alt="ảnh điện thoại"
												style="height: 250px" />
											<h2>${sp.dongia}VNĐ</h2>
											<p>${sp.tensanpham}</p>
											<a
												href="${pageContext.request.contextPath }/AddCart/${sp.masanpham}"
