...
public class SOAPClient {
	...
	public static void main(String args[]) {
		 ...
		 */
		/*
		 * String soapEndpointUrl = "http://www.webservicex.net/uszip.asmx"; String
		 * soapAction = "http://www.webserviceX.NET/GetInfoByCity";
		 */
		
		String soapEndpointUrl = "http://localhost:8080/WebJava10/services/SanPhamServiceImple";
		String soapAction = "getAllSanPham";
	...
	private static void createSoapEnvelope(SOAPMessage soapMessage) throws SOAPException {
		...
		String myNamespace = "SanPhamServiceImpleService";
		String myNamespaceURI = "http://serviceImpl.service";
