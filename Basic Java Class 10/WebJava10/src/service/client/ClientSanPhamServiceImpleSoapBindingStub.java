/**
 * SanPhamServiceImpleSoapBindingStub.java
 *
...
public class ClientSanPhamServiceImpleSoapBindingStub extends org.apache.axis.client.Stub
	...
	public ClientSanPhamServiceImpleSoapBindingStub() throws org.apache.axis.AxisFault {
		this(null);
	}

	public ClientSanPhamServiceImpleSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service)
			throws org.apache.axis.AxisFault {
		this(service);
		super.cachedEndpoint = endpointURL;
	}

	public ClientSanPhamServiceImpleSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
		if (service == null) {
	...
	public java.lang.String getAllSanPham() throws java.rmi.RemoteException {
		...
		_call.setOperationName(new javax.xml.namespace.QName("http://serviceImpl.service", "getAllSanPham"));
	...
	public model.SanPham getSanPham(int id) throws java.rmi.RemoteException {
		...
		_call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
		_call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
		_call.setOperationName(new javax.xml.namespace.QName("http://serviceImpl.service", "getSanPham"));
		...
		try {
			...
			if (_resp instanceof java.rmi.RemoteException) {
				...
				extractAttachments(_call);
				try {
					return (model.SanPham) _resp;
				} catch (java.lang.Exception _exception) {
					return (model.SanPham) org.apache.axis.utils.JavaUtils.convert(_resp, model.SanPham.class);
				}
			}
		} catch (org.apache.axis.AxisFault axisFaultException) {
			throw axisFaultException;
