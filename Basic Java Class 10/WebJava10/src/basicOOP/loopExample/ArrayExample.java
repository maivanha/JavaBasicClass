...
public class ArrayExample {
	...
	public void findPrime() {
		...
		for(int a : ar) {
			if(checkPrime(a)) {
				if(check == false) System.out.print("So nguyen to: ");
				System.out.print(a + ";\t");
				check = true;
			}
		}
		if(check == false) System.out.println("Khong co so nguyen to");
	}
	
	/**
	 * Kiểm tra số <code>n</code> có phải là số nguyên tố hay không</br>
	 * lấy n chia cho từ 2 đến căn bậc 2 của n, nếu có phép chia hết
