	...
	<body>
		<script>
			...
			function submitFunction(button){
				...
				for(i = 0; i < inputs.length; i ++){
					...
					if(input.getAttribute('batbuoc') == 'true'){
						if(input.value.length == 0) {
							errorMessage += input.getAttribute('inputName') + " báº¯t buá»c pháº£i nháº­p;"
				...
				if(categories.length < 1) errorMessage += "Báº¡n cáº§n chá»n má»t sáº£n pháº©m Æ°a thÃ­ch;";
				if(gioiTinh.length < 1) errorMessage += "Báº¡n cáº§n chá»n giá»i tÃ­nh;";
		...
		<div class="formBorder">
			...
			<form action="./PersonController" method="post" style="border: 1px solid blue;" name="userForm">
				<table border="1" style="border-collapse:collapse">
					...
					<tr>
						...
						<td><input batbuoc="true" inputName="TÃªn" onchange="onchangeFunction(this)" onfocus="onfocusFunction(this)" onblur="onblurFunction(this)" 
					...
					<tr>
						...
						<td><input batbuoc="true" inputName="Há»" onchange="onchangeFunction(this)" onfocus="onfocusFunction(this)" onblur="onblurFunction(this)" 
					...
					<tr>
						...
						<td><input batbuoc="true" inputName="TÃªn ÄÄng nháº­p" onfocus="onfocusFunction(this)" onblur="onblurFunction(this)" type="text" name="username"/></td>
					</tr>
					<tr>
						<td class="inputLabel">
							<div class="batbuoc">PassWord:</div>
						</td>
						<td><input batbuoc="true" inputName="Máº­t kháº©u" onfocus="onfocusFunction(this)" onblur="onblurFunction(this)" id="password" maxlength="20" size="22" type="password" name="passWord"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<textarea name="address" cols="50" rows="5">Nhập địa chỉ của bạn</textarea>
						</td>
					</tr>
					<tr>
						...
						<td>
							...
							<input type="radio" name="gioiTinh" value="2">Giới tính khác</input>
						</td>
					</tr>
					<tr>
						<td class="inputLabel">Loáº¡i sáº£n pháº©m quan tÃ¢m:</td>
						<td>
							<input type="checkbox" name="categories" value="01">Smart Phone</input>
							<input type="checkbox" name="categories" value="02">Laptop</input>
							<input type="checkbox" name="categories" value="03">MÃ¡y tÃ­nh bÃ n</input>
							<input type="checkbox" name="categories" value="Äiá»n thoáº¡i cá»">Äiá»n thoáº¡i cá»</input>
						</td>
					</tr>
					<tr>
						<td class="inputLabel">MÃ u yÃªu thÃ­ch:</td>
					...
					<tr>
						<td colspan="2" align="center">
							...
							<!-- <button onclick="submitFunction(this)">Lưu Button</button> -->
