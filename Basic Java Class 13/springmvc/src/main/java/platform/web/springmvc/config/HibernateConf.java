...
public class HibernateConf {
	...
	public LocalSessionFactoryBean getSessionFactory() {
		...
		/*System.out.println("-----> HibernateConfiguration--> sessionFactory-->SessonFactory:"
	...
	public HibernateTransactionManager transactionManager(SessionFactory s) {
		...
		HibernateTransactionManager txManager = new HibernateTransactionManager(s); // txManager.setSessionFactory(s);
